...
const NavBar: React.FC<Props> = () => {
    ...
    return (
        <nav className="relative mx-2 md:mx-4 h-[80px] md:h-[105px] rounded-[20px] md:rounded-[25px] border border-[#1f1f1f] bg-black px-4 md:px-8 flex items-center justify-between shadow-[0_0_20px_rgba(255,255,255,0.05)]">
            ...
            <div className="hidden lg:flex items-center">
                <p className="font-montserrat font-[600] tracking-[1px] uppercase text-sm border-r border-[#C89A3C] px-6 text-white cursor-pointer hover:text-[#F2E6CF] transition-all duration-300">
                    Dashboard
                </p>
                ...
                <p className="font-montserrat font-[600] tracking-[1px] uppercase text-sm px-6 text-white cursor-pointer hover:text-[#F2E6CF] transition-all duration-300">
                    Features
                </p>
